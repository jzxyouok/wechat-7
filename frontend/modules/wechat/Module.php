...
class Module extends \yii\base\Module
{
    ...
    public $defaultCateMenus = [
        'system' => [
            ['label' => '公众号列表', 'url' => ['/wechat/index/index']]
        ],
        'fans' => [
        ...
        'basic' => [
            ['label' => '文字回复', 'url' => ['/wechat/reply/index']],
            ['label' => '图文回复', 'url' => ['/wechat/reply/news']],
            ['label' => '音乐回复', 'url' => ['/wechat/reply/music']],
            ['label' => '图片回复', 'url' => ['/wechat/reply/images']],
            ['label' => '语音回复', 'url' => ['/wechat/reply/voice']],
            ['label' => '视频回复', 'url' => ['/wechat/reply/video']],
        ],
        'advanced' => [

                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" role="form">
                            ...
                            <div ng-if="_menu.type" ng-hide="_menu[menuTypes[_menu.type].value]" class="form-group">
                                <label for="menuName" class="col-sm-2 control-label">{{_menu.type == 'click' ? '关键字' : _menu.type == 'view' ? '链接地址' : '类型值'}}</label>

                                <div class="col-sm-10">
                                    <input ng-model="_menu[menuTypes[_menu.type].meta]" value="{{menuTypes[_menu.type].value}}" type="text" class="form-control" id="menuName">
                                </div>
                            </div>
                        </form>
                    </div>
